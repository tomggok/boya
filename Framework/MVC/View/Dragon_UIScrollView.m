...
{
    NSMutableDictionary *dict = [[NSMutableDictionary alloc] initWithObjectsAndKeys:scrollView, @"scrollView", velocity, @"velocity", targetContentOffset, @"targetContentOffset", nil];
