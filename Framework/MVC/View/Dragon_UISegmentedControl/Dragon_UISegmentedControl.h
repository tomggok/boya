...
@protocol DragonUISegmentedControlDelegate

- (void)segmentedControl:(DragonUISegmentedControl*)segmentedControl didSelectIndex:(NSUInteger)index;
...
@interface DragonUISegmentedControl : UIControl
{
...
@property (nonatomic, strong, readonly) DragonUISegmentedThumb *thumb;
...
@property (nonatomic, unsafe_unretained) id<DragonUISegmentedControlDelegate> delegate DEPRECATED_ATTRIBUTE; // use addTarget:action:forControlEvents: instead
