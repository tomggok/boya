...
@class DragonUITableViewAgent;
@interface DragonUITableView : UITableView<UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate>
{
    StateView *headerView;
    StateView *footerView;
    
//    DragonUITableViewAgent *_agent;
